package anuja.divekar.userappfitness.services;

import java.util.List;

import anuja.divekar.userappfitness.model.Expart_name;
import anuja.divekar.userappfitness.model.ExpertPlan;
import anuja.divekar.userappfitness.model.Experts;
import anuja.divekar.userappfitness.model.MySliderList;
...
public interface ServiceApi {
    ...
    @POST("getSubsbtn.php")
    @FormUrlEncoded
    Call<ExpertPlan> getSubsbtn(@Field("email") String email, @Field("expert_plans_id") String expert_plans_id);
}
